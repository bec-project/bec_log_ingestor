...
pub async fn consumer_loop(rx: &mut mpsc::UnboundedReceiver<LogMsg>, config: LokiConfig) {
    ...
    loop {
        ...
        println!("sent {open} logs to loki, response OK: {ok:?}");
        if !ok {
...
";
    ...
    fn test_make_docs_values_empty() {
        ...
        assert_eq!(
            docs.to_string(),
            "{\"streams\":[{\"stream\":{\"job\":\"bec-logs\"},\"values\":[]}]}"
        );
    }
    ...
    fn test_make_docs_values_single() {
        ...
        assert_eq!(
            docs.to_string(),
            "{\"streams\":[{\"stream\":{\"job\":\"bec-logs\"},\"values\":[[\"1234567890000000\",\"hello\",{\"beamline_name\":\"x99xa\",\"file_location\":\"\",\"file_name\":\"\",\"function\":\"\",\"line\":\"0\",\"log_type\":\"info\",\"module\":\"\",\"proc_id\":\"0\",\"service_name\":\"test_service\"}]]}]}"
        );
    }
    ...
    fn test_make_docs_values_multiple() {
        ...
        assert_eq!(
            docs.to_string(),
            "{\"streams\":[{\"stream\":{\"job\":\"bec-logs\"},\"values\":[[\"1234567890000000\",\"a\",{\"beamline_name\":\"x99xa\",\"file_location\":\"\",\"file_name\":\"\",\"function\":\"\",\"line\":\"0\",\"log_type\":\"info\",\"module\":\"\",\"proc_id\":\"0\",\"service_name\":\"test_service\"}],[\"1234567890000000\",\"b\",{\"beamline_name\":\"x99xa\",\"file_location\":\"\",\"file_name\":\"\",\"function\":\"\",\"line\":\"0\",\"log_type\":\"warn\",\"module\":\"\",\"proc_id\":\"0\",\"service_name\":\"test_service\"}]]}]}"
        );
    }
}
